...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  void initState() {
    ...
    // TODO: conectar con el modelo/servicio real de usuario.
    _nameController = TextEditingController(text: 'Carlos');
    _lastNameController = TextEditingController(text: 'García');
    _emailController = TextEditingController(text: 'carlos@example.com');
  }
  ...
  Future<void> _save() async {
    ...
    // TODO: persistir cambios (Firestore/Backend) y manejar loading/errores.
    if (!mounted) return;
      ...
      children: [
        ...
        TextField(
          ...
          decoration: InputDecoration(
            filled: true,
            fillColor: enabled ? AppColors.surfaceSoft.withValues(alpha: 0.55) : AppColors.surfaceSoft.withValues(alpha: 0.40),
                        ...
                        children: [
                          ...
                          Positioned(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                // TODO: selector de imagen (web/file picker) + subida.
                              },
                              child: Container(
                                width: 54,
                                height: 54,
